...
// import 'package:image/image.dart' as img_utils;
...
//   const CameraScreen({this.randomPhotoName = true});
...
//   ValueNotifier<Size> _photoSize = ValueNotifier(Size(100, 100));
...
//     final img = img_utils.decodeImage(file.readAsBytesSync());
